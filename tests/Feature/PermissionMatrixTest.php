...
test('the permission matrix matches the standard roles', function (RoleName $role, PermissionName $permission, bool $allowed) {
    ...
    'admin can manage documents' => [RoleName::Admin, PermissionName::DocumentsManage, true],
    'admin can manage tasks' => [RoleName::Admin, PermissionName::TasksManage, true],
    ...
    'treasurer cannot manage documents' => [RoleName::Treasurer, PermissionName::DocumentsManage, false],
    'treasurer cannot manage tasks' => [RoleName::Treasurer, PermissionName::TasksManage, false],
    ...
    'member cannot manage documents' => [RoleName::Member, PermissionName::DocumentsManage, false],
    'member cannot manage tasks' => [RoleName::Member, PermissionName::TasksManage, false],
    ...
    'staff cannot manage documents' => [RoleName::Staff, PermissionName::DocumentsManage, false],
    'staff cannot manage tasks' => [RoleName::Staff, PermissionName::TasksManage, false],
]);
